...
import type { InputSpec, TextInputSpec, ImageInputSpec, PixelArtInputSpec, SubmissionResult, RendererContext } from '../../src/shared/types';
...
import { mountPixelArtModule } from './modules/pixelart.js';
